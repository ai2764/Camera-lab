...
MODULES: tuple[CameraLabModule, ...] = (
    ...
    CameraLabModule(
        ...
        workflows=("ltx_director_2.json",),
        required_nodes=("LTXDirector", "LTXDirectorGuide", "LTXDirectorCropGuides"),
        model_profiles=(
            ModelProfile(
                ...
                compatible_workflows=("ltx_director_2.json",),
                notes="Drop-in profile for the bundled LTX Director 2 workflow (UNETLoader distilled transformer, no separate LoRA, LTXDirectorCropGuides).",
            ),
        ),
    ),
    CameraLabModule(
